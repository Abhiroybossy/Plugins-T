...
class Config(object):
    ...
    API_HASH = os.environ.get("API_HASH", "2639a86445b6d7717909ee646e13354c")
    APP_ID = os.environ.get("APP_ID", "20944187")
    BL_CHAT = set(int(x) for x in os.environ.get("BL_CHAT", "").split())
    BOT_HANDLER = os.environ.get("BOT_HANDLER", "./")
    BOT_LIBRARY = os.environ.get("BOT_LIBRARY", None)
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "5998172680:AAHQLAFHy_OSF2LnlqUnn2QqmkU4Xcf0uQE")
    BOT_USERNAME = os.environ.get("BOT_USERNAME", "its_cute_hell_bot)
    BUTTONS_IN_HELP = int(os.environ.get("BUTTONS_IN_HELP", 7))
    CURRENCY_API = os.environ.get("CURRENCY_API", None)
    DATABASE_URL = os.environ.get("DATABASE_URL", "postgres://lzsdumzs:hVxl2M4cZyLocKG4CUSGtuUqED44MZRw@tiny.db.elephantsql.com/lzsdumzs")
    ...
    HELLBOT_SESSION = os.environ.get("HELLBOT_SESSION", "==HEll1BVtsOIIBu6a6at3wdqziScoazrU6gT-Kr_rhHA-ByOk2S-vENJZRpwcAdsFfY-SG8y1Vs38KNLOuSYckNTVD5SLq9eSGaCfMBEGFFpHeZScP5nk4oixV9D_MTqgA8domEk09iaSvSbFwrx17afBOWfY6Bl-Jkrf0RBG1OR8QrMy6cBODEAcXYkSD0gWNS9y3-16o0-5EIbdlebZFIAC54LtaYbTjm0myCBLZ1ZYuEcAAeoiEvLYaKO-NwcOlpaE4I1kAT7i5XLouu3yo_zpFRtfxPq3-TRNGuhYNOdEkiHPZ9CRvFTKGXhnBQb87lj4VMeVPDedRzUbDsHCjHALX0Q1m7hbg5po=BOT==")
